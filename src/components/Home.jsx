  ...
  return (
    <section className={`flex justify-center items-center min-h-[100vh] bg-home relative`} id="home">
        <div className="max-w-[540px] text-center">
            ...
            <motion.h1  initial={{ fontSize: "1rem" }} animate={{ fontSize : "1.875rem"}}  className="font-bold text-3xl mb-2">Shubham Garg</motion.h1>
            <span className='text-md font-semibold text-slate-500'>I am a full Stack Developer</span>
            <HeaderSocials/>              
